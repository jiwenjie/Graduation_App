 ...
 *  version:1.0
 */
class BaseFragmentPagerAdapter(fragmentManager: FragmentManager, fragmentList: ArrayList<Fragment>, titles: Array<String>): FragmentPagerAdapter(fragmentManager) {
